...
- (void)viewDidLoad
{
    ...
    FlatLabel *record = [FlatLabel FlatLabelWithFrame:CGRectMake(0,0,320,44) WithText:@"record" andBackgroundColor:[UIColor colorWithRed:(float)255/255 green:(float)101/255 blue:(float)136/255 alpha:1]];
    ...
    _menu = [[REMenu alloc] initWithItems:@[recordItem, exportItem, reviewItem, playItem]];
